...
class StepUpBarChartRenderer (
    ...
    override fun drawDataSet(c: Canvas?, dataSet: IBarDataSet?, index: Int) {
        ...
        dataSet?.barBorderColor?.let { it ->
            mBarBorderPaint.color = it
            dataSet.barBorderWidth.let { Utils.convertDpToPixel(it) }.let {
                mBarBorderPaint.strokeWidth = it
            }
        }
        ...
        buffer.setBarWidth(mChart.barData.barWidth / 2.0f)
